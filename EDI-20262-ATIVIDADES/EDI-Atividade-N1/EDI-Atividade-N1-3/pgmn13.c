...
/*                             Id da Atividade: EDI-Atividade-N1-3                  */
/*                                                                                  */
...
int buscarVeiculoRecursivo(Veiculo *frota, int indice, int quantidade, char placa[8]){//procura e compara a placa com a placa procurada 
    if(indice == quantidade){
        return -1;
    }
...
int main()
{
    ...
    int indiceEncontrado = buscarVeiculoRecursivo(frota, indice, quantidade, placaProcurada);
